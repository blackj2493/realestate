...
const SECTIONS: LegalSection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      `VOW access records. When you are signed in and view sold or off-market listing data ("VOW" data), we keep a minimal record that your account accessed that listing at that time. We are required by the real estate board that licenses this data to maintain such an access record and to make it available to the board on request. These records contain only your account identifier, the listing accessed, and the time — no listing prices or other content — and are kept for a limited retention period and then deleted.`,
  ...
  },
  {
    ...
    paragraphs: [
      ...
      `These providers fall into a small number of categories: application hosting and database providers (for the Service and for your account, profile, and watchlist data); authentication providers that issue and validate magic-link sign-ins; email-delivery providers for transactional and price-drop alert emails; mapping and geocoding providers; listing-search infrastructure providers; and product-analytics providers. Some of these providers process or store data in the United States; where your personal information is transferred outside Canada, it remains subject to this Policy and applicable law and may be accessible to authorities in those jurisdictions as permitted by their laws.`,
