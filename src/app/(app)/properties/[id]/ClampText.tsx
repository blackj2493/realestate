  ...
  return (
    <div>
      ...
      <button
        ...
        className="mt-2 min-h-[44px] text-xs font-semibold uppercase tracking-wider text-cyan-700 dark:text-cyan-400 active:text-cyan-600 dark:active:text-cyan-300"
      >
