    ...
    <div className="flex items-center justify-between py-2 px-1">
      ...
      <div className="flex items-center gap-1">
        <button
          ...
          disabled={value <= min}
          className="w-6 h-6 flex items-center justify-center rounded bg-muted hover:bg-muted disabled:opacity-30 text-muted-foreground transition-colors"
        >
  ...
  return (
    <button
      ...
      className={cn(
        ...
        value
          ? "bg-emerald-900/30 border-emerald-700/50 text-emerald-700 dark:text-emerald-300"
    ...
    <div className="space-y-3 py-2">
      ...
      <div className="px-1">
        ...
        <div className="flex justify-between mt-1">
          <span className="text-[10px] text-muted-foreground font-mono">{prefix}{min}{suffix}</span>
          <span className="text-[10px] text-muted-foreground font-mono">{prefix}{max}{suffix}</span>
        </div>
      </div>
    </div>
  );
...
export default function CommandCenterSidebar({ onFiltersChange, className }: CommandCenterSidebarProps) {
  ...
  return (
    <div className={cn("bg-card h-full flex flex-col", className)}>
      {/* Header */}
      ...
      <div className="p-3 border-b border-border">
        <div className="bg-muted rounded-lg p-1 grid grid-cols-3 gap-1">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4 scrollbar-thin">
              ...
              <div className="flex gap-2 mt-2">
                <div className="flex-1">
                  ...
                  <Input
                    ...
                    className="h-8 bg-card border-border text-xs font-mono text-foreground"
                    placeholder="0"
                  />
                </div>
                <div className="flex-1">
        ...
        {activePersona === "primary" && (
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <h3 className="text-sm font-medium text-muted-foreground mb-2">Primary Residence</h3>
            <p className="text-xs text-muted-foreground">Standard search mode</p>
          </div>
        )}
      </div>
      ...
      <div className="p-3 border-t border-border space-y-2">
        <Button
          variant="outline"
          size="sm"
          className="w-full h-9 text-xs bg-muted border-border text-foreground hover:bg-muted hover:text-foreground"
        >
