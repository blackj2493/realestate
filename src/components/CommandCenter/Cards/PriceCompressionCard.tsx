    ...
    `}>
      ...
      <div className="mb-4">
        ...
        <div className={`
          ...
          ${isAlarm ? 'text-rose-500' : 'text-amber-700 dark:text-amber-400'}
        `}>
      ...
      {isAlarm && (
        <div className={`
          ...
          text-rose-700 dark:text-rose-400 font-mono text-xs px-2 py-1 rounded mb-4
        `}>
      ...
      <div className="border-t border-border pt-3 mt-3">
        ...
        <div className="text-xl font-mono text-emerald-700 dark:text-emerald-400">
