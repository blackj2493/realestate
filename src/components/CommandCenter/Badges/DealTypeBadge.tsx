    ...
    case 'LEGAL_DISTRESS':
      return (
        <div className={`
          ...
          text-rose-400 font-mono text-xs px-2 py-0.5 rounded
          ${className}
        `}>
    ...
    case 'FIXER_UPPER':
      return (
        <div className={`
          ...
          text-amber-400 font-mono text-xs px-2 py-0.5 rounded
          ${className}
        `}>
    ...
    case 'MOTIVATED_SELLER':
      return (
        <div className={`
          ...
          text-blue-400 font-mono text-xs px-2 py-0.5 rounded
          ${className}
        `}>
          💸 MOTIVATED SELLER
        </div>
