        ...
        <div className="mb-3">
          ...
          <div className="mt-1.5 flex flex-wrap gap-1.5">
            {s.rentIncludes.map((item) => (
              <span
                key={item}
                className="rounded bg-emerald-500/12 px-2 py-0.5 text-[11px] text-emerald-700 dark:text-emerald-300"
              >
                {item}
              </span>
            ))}
        ...
        <div className="mb-3">
          ...
          <div className="mt-1.5 flex flex-wrap gap-1.5">
            {s.utilitiesExtra.map((item) => (
              <span
                key={item}
                className="rounded bg-amber-500/12 px-2 py-0.5 text-[11px] text-amber-700 dark:text-amber-300"
              >
                {item}
              </span>
            ))}
